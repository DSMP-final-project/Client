                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    className={`appearance-none block w-full pl-10 pr-3 py-2 border bg-primary text-white placeholder-gray-300 ${
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`appearance-none block w-full pl-10 pr-10 py-2 border bg-primary text-white placeholder-gray-300 ${
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={isLoading}
                                className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-accent hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent ${
                        ...
                        <div>
                            <button
                                type="button"
                                className="w-full flex items-center justify-center gap-3 bg-white border-2 border-accent text-accent rounded-lg py-3 px-4 hover:bg-gray-50 transition-colors"
                            >
